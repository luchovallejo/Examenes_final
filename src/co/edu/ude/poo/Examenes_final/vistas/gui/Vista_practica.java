 ...
 */
public class Vista_practica extends javax.swing.JFrame {

    /**
     * Creates new form Vista_profesor
     */
    public Vista_practica() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_practica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_practica().setVisible(true);
            }
        });
    }
